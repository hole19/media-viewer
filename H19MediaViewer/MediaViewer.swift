...
public class MediaViewer: UIViewController {
    ...
    override public func viewDidLoad() {
        ...
        if transitionAnimator == nil {
            transitionAnimator = MediaViewerTransitionAnimator(sourceImageView: sourceImageView,
    ...
    private func setupContentsView() {
        contentsView = MediaViewerContentsView(frame: view.bounds,
                                               mediaViewerDelegate: transitionDelegate,
                                               allowLandscapeDismissal: allowLandscapeDismissal)
