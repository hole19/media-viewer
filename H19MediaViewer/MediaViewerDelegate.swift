...
@objc public protocol MediaViewerDelegate {
    ...
    @objc optional func loadMoreImages(withImages images: [MediaViewerImageModel], completition: (_ newImages: [MediaViewerImageModel]?, _ error: NSError?) -> Void) -> Operation?
}
